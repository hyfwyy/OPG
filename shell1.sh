...
python train_scst.py --device=cuda:0 --output_dir=checkpoints_all/swinv2-trans-gpt-frozen-use-mask0.9 --mapping_type=transformer --only_prefix --threshold=0.9 --use_sparce_mask=True
